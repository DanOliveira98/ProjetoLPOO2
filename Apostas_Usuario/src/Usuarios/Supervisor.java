...
public class Supervisor extends Usuario {
    ...
    public Supervisor(int idSupervisor, int matricula, String nome, String cpf, String telefone, String endereco) {
    ...
    public Usuario gerarCadastro() {
        ...
        do {
            try {
                mat = Integer.parseInt(JOptionPane.showInputDialog("Informe a Matricula do Supervisor"));
                setMatricula(mat);
                testmat = 0;
        ...
        } while (testmat != 0);
        {
            ...
            do {
                try {
                    String cpf = JOptionPane.showInputDialog("Informe o cpf do Supervisor");
        ...
        String end = JOptionPane.showInputDialog("Informe o endereco do Supervisor");
        setEndereco(end);
        int testeTelefone = 0;
        int testTel;
        do {
            try {
                String telefone = JOptionPane.showInputDialog("Informe o telefone do Supervisor");
        ...
        do {
            try {
                sald = Float.parseFloat(JOptionPane.showInputDialog("Informe o saldo Supervisor"));
                setSaldo(sald);
                testesald = 0;
            } catch (NumberFormatException e) {
                testesald = 1;
        ...
        u = new Supervisor(idSupervisor, matricula, nome, cpf, telefone, endereco);
        return u;
    }
