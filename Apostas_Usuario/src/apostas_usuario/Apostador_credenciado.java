...
public class Apostador_credenciado extends Apostador {
    ...
    public Apostador_credenciado(int idApostador, int matricula, String nome, String cpf, String telefone, String endereco) {
        super(idApostador, matricula, nome, cpf, telefone, endereco);
    }

    public Apostador_credenciado() {
    ...
    public Usuario gerarCadastro() {
        apc++;
        u = new Apostador_credenciado();
        nome = JOptionPane.showInputDialog("Informe o nome do Apostador credenciado");
        setNome(nome);
        int mat = 0;
        int testmat;
        do {
            try {
                mat = Integer.parseInt(JOptionPane.showInputDialog("Informe a Matricula do Apostador credenciado"));
                setMatricula(mat);
                testmat = 0;
            } catch (NumberFormatException e) {
                testmat = 1;
        ...
        } while (testmat != 0);
        {
            ...
            do {
                try {
                    String cpf = JOptionPane.showInputDialog("Informe o cpf do Apostador credenciado");
        ...
        String end = JOptionPane.showInputDialog("Informe o endereco do Apostador credenciado");
        setEndereco(end);
        int testeTelefone = 0;
        int testTel;
        do {
            try {
                String telefone = JOptionPane.showInputDialog("Informe o telefone do Apostador credenciado");
        ...
        do {
            try {
                sald = Float.parseFloat(JOptionPane.showInputDialog("Informe o saldo Apostador credenciado"));
                setSaldo(sald);
                testesald = 0;
            } catch (NumberFormatException e) {
                testesald = 1;
        ...
        u = new Apostador_credenciado(apc, matricula, nome, cpf, telefone, endereco);
        return u;
    }

    @Override
    public String imprimirApostador() {
        return "Nome Apostador Credenciado: " + nome
                + "\nMatricula: " + matricula
                + "\n ID Apostador Credenciado: " + apc
                + "\nCpf: " + cpf
                + "\nTelefone: " + telefone
                + "\n endereco: " + endereco;
    }
